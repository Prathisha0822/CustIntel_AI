...
def clean_and_load_data():
    ...
    try:
        ...
        dim_payments = payments[['order_id', 'payment_sequential', 'payment_type', 'payment_installments', 'payment_value']]
        dim_payments.to_sql('Dim_Payments', conn, if_exists='append', index=False)
